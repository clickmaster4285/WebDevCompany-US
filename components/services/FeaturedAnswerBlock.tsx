      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="group relative rounded-2xl border border-border/60 bg-surface-1/50 p-8 shadow-soft backdrop-blur-sm transition-all duration-300 hover:border-violet/30 hover:shadow-violet-glow md:p-12">
            ...
            {/* Quote icon */}
            <motion.div
              className="absolute -top-5 -left-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-violet to-violet-soft text-white shadow-violet-glow md:-top-6 md:-left-6 md:h-14 md:w-14"
