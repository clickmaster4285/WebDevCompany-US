...
export interface Testimonial {
  ...
  title: string;
  description: string;
  imageUrl: string; // Path to image in public/assets/testimonials/
  githubUrl?: string;
  twitterUrl?: string;
  youtubeUrl?: string;
  linkedinUrl?: string;
...
export const testimonials: Testimonial[] = [
  {
    ...
    imageUrl: "/assets/testimonials/michel-chen.avif",
    githubUrl: "#",
    twitterUrl: "#",
    youtubeUrl: "#",
    linkedinUrl: "#",
  ...
  },
  {
    ...
    imageUrl: "/assets/testimonials/jessica.avif",
    githubUrl: "#",
    twitterUrl: "#",
    youtubeUrl: "#",
    linkedinUrl: "#",
  ...
  },
  {
    ...
    imageUrl: "/assets/testimonials/williams carter.avif",
    githubUrl: "#",
    twitterUrl: "#",
    youtubeUrl: "#",
    linkedinUrl: "#",
  ...
  },
  {
    ...
    imageUrl: "/assets/testimonials/sarah carter.avif",
    rating: 5,
  ...
  },
  {
    ...
    imageUrl: "/assets/testimonials/photo-1507003211169-0a1dd7228f2d.avif",
    rating: 5,
  ...
  },
  {
    ...
    imageUrl: "/assets/testimonials/emily.avif",
    rating: 4,
    company: "GrowthLab",
    industry: "Marketing",
...
export function getTestimonialsByIndustry(industry: string) {
  if (industry === "all") return testimonials;
...
export function getTestimonialsWithVideo() {
  return testimonials.filter((t) => t.videoUrl);
}

export function getTestimonialByIndex(index: number) {
